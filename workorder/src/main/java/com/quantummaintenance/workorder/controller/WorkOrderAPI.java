...
//	@Autowired
	...
	@GetMapping(value="/getWorkOrderListByCustomerId/{customerId}")
	public ResponseEntity<List<WorkOrderDTO>> getWorkOrderListByCustomerId(@PathVariable String customerId){
//	
//		HttpHeaders headers = new HttpHeaders();
//        headers.set("Authorization", token);
//        HttpEntity<Customer> entity = new HttpEntity<>(headers);
...
//        );
		...
		List<WorkOrderDTO> workOrderDTOList=workOrderService.getWorkOrderByCustomerId(customerId);
...
//	}
	...
	public void addExtraFieldName(@RequestBody ExtraFieldNameDTO extraFieldNameDTO) throws Exception {
		workOrderService.addWorkOrderExtraField(extraFieldNameDTO);
	}
	...
	@GetMapping("/allWorkOrderWithExtraFields/{companyId}")
	public List<String> getAllWorkOrderList(@PathVariable String companyId){
		return workOrderService.workOrderAllData( companyId);
	}
	@GetMapping("/getWorkOrderByTechnicianId/{companyId}/{id}")
	public Boolean getWorkOrderByTechnicianId(@PathVariable String companyId,@PathVariable String id){
		System.out.println("workiong-----technician Id------------------"+id);
		List<WorkOrderDTO> WorkOrderDTOList=  workOrderService.getWorkOrderByTechnicianId(companyId, id);
		System.out.println("workiong-----------------------"+WorkOrderDTOList.size());
	...
	@PostMapping("/updateWorkOrdersWithClosed")
	public void updateWorkOrdersInActive(@RequestBody String customerId) {
		System.out.print(customerId);
		workOrderService.updateWorkOrdersWithClosed(customerId);
